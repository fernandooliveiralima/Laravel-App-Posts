<x-layout>
    <x-header>
        <div class="mt-4">
            <h1 class="p2 text-slate-700 dark:text-slate-200">Register Layout</h1>
        </div>
    </x-header>
    ...
    <div class="max-w-2xl mx-auto p-4">
        <form action="{{ route('register.store') }}" method="POST">
            ...
            <div class="mb-6">
                <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Register
                </button>
            </div>
